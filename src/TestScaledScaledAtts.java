...
//This machine learning tests runs on the libsvm file that was created when we used the influence scaled from : <.1, <.2, <.3...
//And All 19 attributes were divided the number of reviews
//And the attributes were scaled again.
public class TestScaledScaledAtts{
...
//				output += " " + counter + ":" + date;
			...
			PrintWriter pwriter = new PrintWriter("scaledScaledAtts-EliteAttributes.txt","UTF-8");
