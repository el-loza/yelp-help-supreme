 ...
 * Note: Our data has run on multiple tests shown but not fully included in: "testML.java", "testML2.java"
...
public class MLearning {
  ...
  public static void main(String[] args) {
    ...
    // $example on$
    // Load training data
    String path = "hdfs://salem:42201/yelp/five-EliteAttributes.txt";
    ...
    result.show(100);
    System.out.println("Test set accuracy = " + (evaluator.evaluate(predictionAndLabels) * 100));
    // $example off$
